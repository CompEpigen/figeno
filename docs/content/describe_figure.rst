...
Track showing base modification frequencies (e.g. methylation), from bam files with MM/ML tags. Several bam files can be visualized in the same track, and they can be split by haplotype.
